...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/logohima.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan Himatemia</h2>
            <p class="text-center">Alamat : Jl. Perumahan belakang UBP, Telukjambe timur, Karawang, Jawa Barat</p>
