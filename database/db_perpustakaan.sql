...
(1, 'Kimia Organik', 'Ensiklopedia', 'Perpustakaan Unsika', 'Teguh Pambudi', '2021', 214748333221, '38', '2'),
(2, 'Laut Bercerita', 'Novel ', 'KPG', 'Leila S. Chudori', '2017', 9786024246945, '40', '0'),
(3, 'Das Kapitalis', 'Esai', 'unknown', 'Karl Marx', '1867', 763447483647, '2', '0');
...
(1, 'Perpustakaan Himatemia', 'Jl. HS Ronggo Waluyo, Puseurjaya, Kec. Telukjambe Timur, Kabupaten Karawang, Jawa Barat', 'digilibhimatemia@e-perpus.com', '6281221545666');
...
INSERT INTO `user` (`id_user`, `kode_user`, `NPM`, `fullname`, `username`, `password`, `Program Studi`, `alamat`, `verif`, `role`, `join_date`, `terakhir_login`) VALUES
(1, '-', '-', 'Administrator', 'admin', 'admin', '-', '-', 'Iya', 'Admin', '04-05-2021', '08-08-2022 ( 13:58:17 )'),
(2, 'AP001', '100011', 'Reza  Saputra', 'reza', 'Reza', 'X - Teknik Kimia', 'Desa Mekarjati, Kecamatan Haurgeulis, Kabupatem Indramayu', 'Tidak', 'Anggota', '08-08-2022', '08-08-2022 ( 13:55:52 )');
